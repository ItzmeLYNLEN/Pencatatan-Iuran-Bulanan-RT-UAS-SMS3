...
<head>
    ...
    <style>
        ...
        .navbar .nav-link { font-weight: 500; color: #6c757d; transition: color 0.2s ease-in-out; }
        .navbar .nav-link.active { color: #0d6efd; font-weight: 600; }
        .navbar .nav-link:hover { color: #0d6efd; }
        .navbar-brand { font-weight: 600; }
        .avatar { width: 40px; height: 40px; border-radius: 50%; background-color: #0d6efd; color: #fff; display: inline-flex; align-items: center; justify-content: center; font-weight: 600; cursor: pointer; }
        .dropdown-menu { border-radius: 0.75rem; box-shadow: 0 0.5rem 1rem rgba(0,0,0,.15); border: none; }
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li>
                            <a class="dropdown-item <?php echo ($current_page == 'profile.php') ? 'active' : ''; ?>" href="profile.php">
                                <i class="fas fa-user-cog fa-fw me-2"></i>Profile Admin
                            </a>
                        </li>
                        <li>
